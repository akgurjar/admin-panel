...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./pages/forgot/forgot.module').then(modules => modules.ForgotModule)
      },
      {
        path: RESET_ROUTE.path,
        loadChildren: () => import('./pages/reset/reset.module').then(modules => modules.ResetModule)
      }
    ]
  }
];
